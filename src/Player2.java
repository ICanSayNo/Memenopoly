...
public class Player2 extends GameObject {
	...
	void draw(Graphics g) {
		...
		if (ObjectManager.player2.spaceValue == ObjectManager.spaces.get(25).id) {
			ObjectManager.player2.inJail = true;
			ObjectManager.player2.spaceValue = ObjectManager.spaces.get(9).id;
			ObjectManager.player2.RollsLeftUntilOutOfJail = 3;
		...
		if (ObjectManager.dice.get(0).value == ObjectManager.dice.get(1).value) {
			...
			ObjectManager.player2.inJail = false;
			}
		}
		if (ObjectManager.player2.inJail == true) {
			ObjectManager.player2.spaceValue = ObjectManager.spaces.get(9).id;
			ObjectManager.player2.x = ObjectManager.spaces.get(9).x+30;
		}

		if (ObjectManager.player2.RollsLeftUntilOutOfJail > 0) {
			if(MemeGamePanel.turn==1) {
				ObjectManager.player2.RollsLeftUntilOutOfJail -= 1;
			}
		} else if (ObjectManager.player2.RollsLeftUntilOutOfJail == 0) {
			ObjectManager.player2.inJail = false;
		}
		if (MemeGamePanel.turn == 1) {
		if (ObjectManager.player2.spaceValue == ObjectManager.spaces.get(6).id
				|| ObjectManager.player2.spaceValue == ObjectManager.spaces.get(11).id
				|| ObjectManager.player2.spaceValue == ObjectManager.spaces.get(19).id
				|| ObjectManager.player2.spaceValue == ObjectManager.spaces.get(27).id) {
			...
			if (chance == 0||chance == 1||chance == 2||chance == 3||chance == 4||chance == 5||chance == 6||chance == 7||chance == 8||chance == 9) {
				...
				ObjectManager.player2.muneez-=100;
				ObjectManager.player2.spaceValue = ObjectManager.spaces.get(12).id;
			}
				...
				ObjectManager.player2.muneez+=10;
				ObjectManager.player2.spaceValue = ObjectManager.spaces.get(14).id;
			}
			else if (chance == 46) {
				g.drawString("YOLO. Gain $1000 for swag.", 1210 ,440);
				ObjectManager.player2.muneez+=1000;
			}
				...
				ObjectManager.player2.muneez-=100;
				ObjectManager.player2.spaceValue = ObjectManager.spaces.get(21).id;
			}
		}
		g.setColor(Color.blue);
		if (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).owner == 0) {
			...
			g.drawString("It costs "+(60 + (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id * 20)) +" Dollars, and pays "+(60 + (ObjectManager.spaces.get(ObjectManager.player1.spaceValue).id * 20)/2)+" when landed on.", 1400 ,320);
			...
			if (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).owner == 1) {
				if (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 1
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 2
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 5
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 7
				...
				g.drawString("You must pay "+(60 + (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id * 20)/2*ObjectManager.spaces.get(ObjectManager.player1.spaceValue).upgrade), 1400 ,340);
				ObjectManager.player2.muneez -= (60 + (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id * 20)/2*ObjectManager.spaces.get(ObjectManager.player2.spaceValue).upgrade);
				ObjectManager.player1.muneez += (60 + (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id * 20)/2*ObjectManager.spaces.get(ObjectManager.player2.spaceValue).upgrade);
				}
			}
			if (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).owner == 2) {
				if (ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 1
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 2
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 5
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 7
						...
						|| ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id == 31) {
				g.setColor(Color.BLUE);
				g.drawString("This property is owned by you", 1400 ,300);
				g.drawString("Would you like to upgrade this property for "+((ObjectManager.spaces.get(ObjectManager.player2.spaceValue).id * 20)/2), 1400 ,320);
				}
			}
		}
		if (ObjectManager.player2.spaceValue == ObjectManager.spaces.get(3).id) {
			g.drawString("You have landed on ''Taxes''", 1400 ,300);
			int taxChance = new Random().nextInt(2500);
			if(taxChance==1) {
				g.drawString("and to our glorious president Trump", 1400 ,340);
				g.drawString("for a great wall.", 1400 ,360);
			}
				g.drawString("You must pay $200 to the government", 1400 ,320);
			ObjectManager.player2.muneez-=200;
		}
		ObjectManager.player2.x = ObjectManager.spaces.get(ObjectManager.player2.spaceValue).x + 45;
		// System.out.println(ObjectManager.spaces.get(ObjectManager.players.get(0).spaceValue).x+5);
		if (ObjectManager.player2.inJail == true) {
			ObjectManager.player2.x = ObjectManager.spaces.get(9).x+85;
		}
		
		ObjectManager.player2.y = ObjectManager.spaces.get(ObjectManager.player2.spaceValue).y + 5;
		if (ObjectManager.player2.inJail == false&&ObjectManager.player2.spaceValue==ObjectManager.spaces.get(9).id) {
			ObjectManager.player2.x = ObjectManager.spaces.get(9).x+5;
			ObjectManager.player2.y = ObjectManager.spaces.get(9).y+45;
		}
		// System.out.println(ObjectManager.spaces.get(ObjectManager.players.get(0).spaceValue).y+5);
		System.out.println("Space Value: " + ObjectManager.player2.spaceValue);
		...
		if (image != null) {
			...
			System.out.println("In jail(p2): " + ObjectManager.player2.inJail);
			System.out.println("Space is on(p2): " + ObjectManager.player2.spaceValue);
			System.out.println("Turns til out of Jail(p2): " + ObjectManager.player2.RollsLeftUntilOutOfJail);
