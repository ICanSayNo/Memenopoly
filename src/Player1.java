...
public class Player1 extends GameObject {
	...
	void draw(Graphics g) {
		...
		if (image != null) {
			...
			System.out.println("In jail: " + ObjectManager.player1.get(0).inJail);
			System.out.println("Space p1 is on: " + ObjectManager.player1.get(0).spaceValue);
			System.out.println("Turns til out of Jail: " + ObjectManager.player1.get(0).RollsLeftUntilOutOfJail);
